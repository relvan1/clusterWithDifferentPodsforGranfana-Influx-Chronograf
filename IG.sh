...
echo ""
echo ""
kubectl create -n $tenant -f $working_dir/jmeter_chronograf_deploy.yaml
kubectl create -n $tenant -f $working_dir/jmeter_chronograf_svc.yaml
echo "Chronograf Part Created"
...
chronograf=`echo $link | awk '{ print $3}'`
...
echo ""
echo ""
echo "Please load the IP in the browser for the Chronograf Dashboard - http://$chronograf/" 
echo ""
echo ""
